const posts = [
  {
    ...
    content: `Most developer portfolios take a weekend. Mine took stubbornness.
...
And if you want to talk about anything I built here — or anything you're building — [reach out](/). I'd love to hear about it.`,
  ...
  {
    slug: "building-multi-agent-code-review",
    ...
    content: `Most code review tools give you a single pass — one model, one perspective, one set of suggestions. I wanted something that thinks the way a real engineering team does: multiple specialists looking at the same code from completely different angles, then synthesizing their findings into one coherent review.
