...
const PROJECTS=[
  ...
  {category:"AI / NLP",title:"T5 Text Simplification",description:"Fine-tuned T5 transformer on the WikiAuto dataset for automated text simplification, optimized for meaningful structural and lexical rewrites rather than surface-level paraphrasing.",tech:["T5","HuggingFace","PyTorch","WikiAuto","Python"],highlights:["SARI-optimized simplification pipeline","Fine-tuned on 50K sentence pairs","Structural and lexical transformation focus"],color:"#9B5DE5",file:"t5_simplify.py"},
];
const EXPERIENCE=[
